...
// var totalmoviesCount=filims.length
// console.log(totalmoviesCount,"movies in total.");



// var moviesBelow140=filims.filter((m1)=>m1.runtime<140).map(m1=>m1.title)
// console.log(moviesBelow140.length);



// var highestRuntime=filims.sort((m1,m2)=>m2.runtime-m1.runtime)
// console.log(highestRuntime[0].title);



// var lowestRuntime=filims.sort((m1,m2)=>m1.runtime-m2.runtime)
// console.log(lowestRuntime[0].title);



// for(let ch of filims){
//     for(let x of ch.genres){
//         if(x=="Action"){
...
//     text.push(ch.year)
// }
// text.map(x=>x in wc ? wc[x]+=1:wc[x]=1)
// var nestedArray=Object.entries(wc)
// var highestRuntime=nestedArray.reduce((m1,m2)=>m1[1]>m2[1]?m1:m2)
